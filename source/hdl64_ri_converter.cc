...
cv::Mat* HDL64RIConverter::convertPc2RinonP(PclPcXYZ pc)
{
  cv::Mat *ri = new cv::Mat(riRow, riCol, CV_32FC1, cv::Scalar(0.f));
...
cv::Mat* HDL64RIConverter::convertPc2RiWithInonP(PclPcXYZI pc)
{
  cv::Mat *ri = new cv::Mat(riRow, riCol, CV_32FC2, cv::Scalar(0.f));
...
PclPcXYZ HDL64RIConverter::reconstructPcFromRinonP(cv::Mat *ri)
{
  double xSum(0), ySum(0), zSum(0), rhoSum(0);
...
PclPcXYZI HDL64RIConverter::reconstructPcFromRiWithI(cv::Mat *ri)
{
  ...
  #pragma omp parallel
  {
    pcl::PointCloud<PclXYZI> privatePc;
    privatePc.reserve(15000);
...
PclPcXYZI HDL64RIConverter::reconstructPcFromRiWithInonP (cv::Mat *ri)
{
  double xSum(0), ySum(0), zSum(0), rhoSum(0);
