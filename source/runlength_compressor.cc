#include "runlength_compressor.h"

std::vector<char> RunLengthCompressor::encode(char *data, int dataSize)
{
...
std::vector<char> RunLengthCompressor::decode(std::vector<char> encoded, int origSize)
{
