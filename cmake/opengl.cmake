macro(use_opengl)
  ...
  #  list(APPEND 3D_PCC_CXX_FLAGS ${OGL_CFLAGS_OTHER})
  #  list(APPEND 3D_PCC_LINKER_FLAGS ${OGL_LDFLAGS})
  #endif()
  ...
  #
  #  list(APPEND 3D_PCC_CXX_FLAGS ${EGL_CFLAGS_OTHER})
  #  list(APPEND 3D_PCC_LINKER_FLAGS ${EGL_LDFLAGS})
  #endif()
  ...
  if(GLEW_FOUND)
    ...
    list(APPEND 3D_PCC_CXX_FLAGS ${GLEW_CFLAGS_OTHER})
    list(APPEND 3D_PCC_LINKER_FLAGS ${GLEW_LDFLAGS})
  endif()
  ...
  if(GLFW_FOUND)
    ...
    list(APPEND 3D_PCC_CXX_FLAGS ${GLFW_CFLAGS_OTHER})
    list(APPEND 3D_PCC_LINKER_FLAGS ${GLFW_LDFLAGS})
  endif()
